...
import 'package:nom_du_projet/home/eventpage/purchasetickets.dart';
import 'package:nom_du_projet/models/eventfuture.dart';
import 'package:nom_du_projet/models/ticketCategorie.dart'; // Importez votre modèle de catégorie de billets
                    ...
                    children: [
                      ...
                      Row(
                        children:[
                            ...
                            SizedBox(width: 03,) ,
                            Text( "${event.views}" , style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w600 , letterSpacing: 02.0  ,fontStyle: FontStyle.italic ),) ,
                        ]
                      ), 
                    ],
                  )
