...
import 'package:nom_du_projet/home/reportingpage.dart';
import 'package:nom_du_projet/home/sugestion.dart';
...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    ...
    final counter = favoritesProvider.favoriteEvents.length ;
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          Padding(
                            ...
                            child: Column(
                              children: [
                                Text( "${counter}" ,style: TextStyle( color: Colors.white , fontWeight: FontWeight.w600 , fontSize: 25 , letterSpacing: 3 , fontStyle: FontStyle.italic)) ,
